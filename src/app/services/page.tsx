...
export const metadata: Metadata = {
  title: "Financial Services & Industries | Debt, PE & M&A Dubai",
  ...
  keywords: ["debt financing", "private equity", "M&A advisory Dubai", "trade facilities", "capital raising services"],
};
